...
export type District = CamelCaseKeys<DistrictsTable["Row"]>;
export type CreateDistrict = CamelCaseKeys<DistrictsTable["Insert"]>;
export type UpdateDistrict = Partial<CamelCaseKeys<DistrictsTable["Update"]>>;
